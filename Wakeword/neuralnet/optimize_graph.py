...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_checkpoint', type=str, default="/home/vboxuser/A-Hackers-AI-Voice-Assistant/VoiceAssistant/wakeword.pt", required=False,
                        help='Checkpoint of model to optimize')
    parser.add_argument('--save_path', type=str, default="/home/vboxuser/A-Hackers-AI-Voice-Assistant/VoiceAssistant/wakeword.pt", required=False,
