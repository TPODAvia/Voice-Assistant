...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_checkpoint_path', type=str, default="D:\\Voice-Assistant\\AudioReaction", help='Path to save the best checkpoint')
    parser.add_argument('--train_data_json', type=str, default="D:\\Voice-Assistant\\AudioReaction\\scripts\\data\\train.json", required=False, help='path to train data json file')
    parser.add_argument('--test_data_json', type=str, default="D:\\Voice-Assistant\\AudioReaction\\scripts\\data\\test.json", required=False, help='path to test data json file')
